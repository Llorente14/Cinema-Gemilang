<div class="flex gap-2 cursor-pointer items-center  " id="middle-menu">
    <p class="text-white/90 text-[1.2vw]  tracking-wide ">Telusuri</p>
    <div class="fill-white/90 size-[1.2vw]">
        <svg viewBox="-3 0 28 28" version="1.1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns"
            transform="rotate(90)" class="group-hover/hamburger:rotate-180 transition-transform duration-300 ease-out">
