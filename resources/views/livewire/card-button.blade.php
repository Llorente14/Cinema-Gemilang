 <a href="{{ $href }}" target="_blank" rel="noreferrer"
     class="{{ $bg }} {{ $border }} {{ $hover }} text-[0.8vw] w-[10vw] px-[55%] py-[7%] font-semibold rounded-full flex gap-2 items-center justify-center  whitespace-nowrap ">

     <div class="size-[1.2vw] fill-current">
         @switch($icon)
             @case('play')
                 <svg class="size-[1vw]" viewBox="0 0 7.00 7.00" xmlns="http://www.w3.org/2000/svg">
                     <path
