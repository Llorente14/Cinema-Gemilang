 <a href="{{ $href }}" target="_blank" rel="noreferrer"
     class="{{ $bg }} {{ $border }} {{ $hover }} {{ $size }} border-2 border-solid font-semibold rounded-full flex gap-2  items-center justify-center  whitespace-nowrap  transition-colors duration-300 ">
