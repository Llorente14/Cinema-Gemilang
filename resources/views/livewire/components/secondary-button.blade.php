<a href="{{ $href }}" target="{{ $newTabTarget }}"rel="noreferrer"
    class="{{ $styleBtn }}  {{ $hoverBtn }} {{ $sizeBtn }} {{ $positionIcon }} group/secBtn flex font-semibold rounded-full gap-2 items-center justify-center tracking-wider  whitespace-nowrap transition-colors duration-300 ">
