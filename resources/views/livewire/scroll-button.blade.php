...
<button x-data
    ...
    "
    class="absolute top-[50%] {{ $isLeft ? 'left-0' : 'right-0' }} opacity-0 z-10 flex items-center justify-center text-center p-2 btn-pagination bg-white fill-dark rounded-full">
