        ...
        <div class="flex flex-col justify-end left-[4%] w-[36%] bottom-[35%] absolute top-0">
            ...
            <div class="flex flex-col gap-2 mb-[1dvw]" id="text-wrap">
                <p class="text-white text-[1.6vw] tracking-wide font-semibold" id="heading">
                    Tonton Koleksi 26 Sekarang
                </p>
                <p class="text-white text-[1.2vw] tracking-wide font-normal">
                    Detektif remaja, Conan, yang berubah menjadi bocah laki-laki karena ramuan jahat, membantu
                    memecahkan
                    ...
                    <div class="size-5 fill-dark">
                        <svg viewBox="0 0 7.00 7.00" version="1.1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"
                                stroke="#CCCCCC" stroke-width="0.014000000000000002"></g>
